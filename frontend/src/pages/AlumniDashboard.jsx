...
export default function AlumniDashboard() {
  ...
  return (
    <DashboardLayout role="alumni" userName={user?.fullname || "Alumni"}>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl mb-2 text-slate-900 font-bold">Welcome Back, {user?.fullname || "Alumni"}!</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <Card className="p-6">
            <h2 className="text-xl mb-4 text-slate-900 font-semibold">Profile Completeness</h2>
          ...
          <Card className="p-6 lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl text-slate-900 font-semibold">Pending Mentorship Requests</h2>
              ...
              {mentorshipRequests.map((request, index) => (
                <div key={index} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="flex-1 bg-teal-600 hover:bg-teal-700 text-white">Accept</Button>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card className="p-6">
            <h2 className="text-xl mb-4 text-slate-900 font-semibold">Upcoming Events</h2>
            <div className="space-y-3">
          ...
          <Card className="p-6">
            <h2 className="text-xl mb-4 text-slate-900 font-semibold">Resume Analysis Summary</h2>
            <p className="text-slate-600 mb-4">Help students improve their resumes and career prospects</p>
            <Button className="w-full bg-teal-600 hover:bg-teal-700 text-white" onClick={() => navigate('/resume-analysis')}>
              View Analysis Tools
            </Button>
          </Card>
        </div>
