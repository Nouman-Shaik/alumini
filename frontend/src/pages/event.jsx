  ...
  return (
    <DashboardLayout role="student" userName="Alex Kumar">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl mb-2 text-slate-900 font-bold">Events</h1>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {upcomingEvents.map((event, index) => (
                <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-xl mb-3 text-slate-900 font-semibold">{event.title}</h3>
                  ...
                  <Button className="w-full bg-red-500 hover:bg-red-600 text-white">Register Now</Button>
                </Card>
              ))}
            </div>
          </TabsContent>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {pastEvents.map((event, index) => (
                <Card key={index} className="p-6">
                  ...
                  <h3 className="text-xl my-3 text-slate-900 font-semibold">{event.title}</h3>
